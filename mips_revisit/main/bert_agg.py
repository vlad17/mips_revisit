...
from ..utils import timeit, import_matplotlib
...
def _setup_main(workdir):
    ...
    for root, dirnames, filenames in os.walk(workdir):
        ...
        for folder in ['dev', 'train']:
            ...
            dir_act = np.load(os.path.join(root, folder, 'average_activations.npy'))
    ...
    for folder in ['dev', 'train', 'diff']:
        ...
        plt.savefig(os.path.join(workdir, filename), format="pdf", bbox_inches="tight")
        plt.clf()
